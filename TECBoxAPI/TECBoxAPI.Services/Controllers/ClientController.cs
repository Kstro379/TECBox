...
namespace TECBoxAPI.Services.Controllers
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        /**
         * Realiza la comprobacion del cliente.
         * @param clientModel: Informacion del cliente.
         ...
         * @param id: Informacion del cliente.
         * @return: Toda la informacion del cliente.
         */
        [HttpGet("{id}")]
         ...
         * @param client: Informacion del cliente.
         * @return: Toda la informacion del cliente actualizada.
         */
        [HttpPut]
