...
namespace TECBoxAPI.Services.Controllers
{
    ...
    public class Branch_OfficerController : ControllerBase
    {
         ...
         * @param branch_Office: Infromacion de la nueva sucursal.
         * @return: Lista actualizada de Sucursales.
         */
        [HttpPost]
         ...
         * @param branch_Office: Informacion de la sucursal a actualizar.
         * @return: Lista de sucursales actualizada.
         */
        [HttpPut]
         ...
         * @param name: Nombre de la sucursal a eliminar.
         * @return: Lista de sucursales actualizada.
         */
        [HttpDelete("{name}")]
